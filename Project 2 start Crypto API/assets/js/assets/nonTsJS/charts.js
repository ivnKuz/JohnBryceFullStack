...
function getChosenCoinsData(chosenCoins = ['ZOC,ETH,ZCN']) {
    return __awaiter(this, void 0, void 0, function* () {
        // `https://min-api.cryptocompare.com/data/pricemulti?fsyms=ZOC,ETH,ZCN,BTC&tsyms=USD`
        const cryptoAPILink = `https://min-api.cryptocompare.com/data/pricemulti?fsyms=${chosenCoins.slice(',')}&tsyms=USD`;
        let coinsArr = [];
